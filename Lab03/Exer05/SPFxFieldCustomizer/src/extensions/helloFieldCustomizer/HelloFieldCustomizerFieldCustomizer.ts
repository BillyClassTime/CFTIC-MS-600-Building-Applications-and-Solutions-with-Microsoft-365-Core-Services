...
export default class HelloFieldCustomizerFieldCustomizer extends BaseFieldCustomizer<IHelloFieldCustomizerFieldCustomizerProperties> {
  @override
  public onInit(): Promise<void> {
    ...
    Log.info(
      LOG_SOURCE,
      "Activated HelloFieldCustomizerFieldCustomizer with properties:"
    );
    Log.info(LOG_SOURCE, JSON.stringify(this.properties, undefined, 2));
    Log.info(
      LOG_SOURCE,
      `The following string should be equal: "HelloFieldCustomizerFieldCustomizer" and "${strings.Title}"`
    );
